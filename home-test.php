		    ...
		    <div class="modal-content">
				 ...
				 <div class="modal-body-pro social-login-modal-body-pro">
					 ...
					 <div class="registration-login-container">
						 <form action="./log.php?id=0" method="POST">
							 ...
							 <div class="container-fluid">
								 <div class="row no-gutters">
									...
									<div class="col forgot-your-password"><a href="./forget.html">Forgot your password?</a></div>
								</div>
							...
							<div class="aligncenter"><a class="not-a-member-pro" href="./register.html">Don't have account? <span>Signup</span></a></div>
