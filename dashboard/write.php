...
<body class="overlay-scrollbar">
			...
			<li class="nav-item avt-wrapper">
				<div class="avt dropdown">
					...
					<ul id="user-menu" class="dropdown-menu">
						...
						<li  class="dropdown-menu-item">
							<a href="#upload" class="dropdown-menu-link">
								<div>
						...
						<li  class="dropdown-menu-item">
							<a href="../logout-writer.php" class="dropdown-menu-link">
								<div>
	...
	<div class="wrapper">
        ...
        <?php
					...
					$qry = $conn->query("SELECT * FROM writer_statistic  where wemail= '".$_SESSION['email']."'");
			...
			<div class="col-3 col-m-6 col-sm-6">
				<div class="counter bg-purple">
					...
					<h3><?php echo $row['submit'] ?></h3>
					<p>Stories Submitted</p>
				</div>
			</div>
			<div class="col-3 col-m-6 col-sm-6">
		...
		<div class="row">
			<div class="col-12 col-m-12 col-sm-12">
				<div class="card">
					...
					$qry = $conn->query("SELECT * FROM writer_stories  ");
					while($row= $qry->fetch_assoc()):
					?>
    ...
    <div class="upload-wrapper">
      <span class="file-name">Choose PDF..</span>
	...
	<!-- end import script -->
							...
							<?php	}
								else{	header('location:../register-writer.php');
								}?>