...
<head>
		...
		<div id="content-pro">
  	 		...
  	 		<div class="container custom-gutters-pro">
				...
				//echo $d;
					...
					$s="select * from more where mid=$id";
					...
					while($data=mysqli_fetch_array($result))
                        ...
                        <div class="progression-studios-video-index-container">
                            <a href="video-seasons-post.html">
                                <div class="progression-studios-video-feaured-image"><img src="./admin_moviebazaar/assets/uploads/<?php echo $data["image1"]; ?>" style="height: 190px; alt="Featured Image"></div>
                            
                                <div class="progression-video-index-content">
                                    <div class="progression-video-index-table">
                                        <div class="progression-video-index-vertical-align">
                                        
                                            <h2 class="progression-video-title"><?php echo $data["name1"]; ?> </h2>
                                            ...
                                            <ul class="video-index-meta-taxonomy"><li><?php  echo $data["cast1"]; ?></li></ul>												
                                            <div class="clearfix"></div>
	...
	//echo $r;
					...
					while($data=mysqli_fetch_array($result))
                        ...
                        <div class="progression-studios-video-index-container">
                            <a href="video-seasons-post.html">
                                <div class="progression-studios-video-feaured-image"><img src="./admin_moviebazaar/assets/uploads/<?php echo $data["image2"]; ?>" style="height: 190px; alt="Featured Image"></div>
                            
                                <div class="progression-video-index-content">
                                    <div class="progression-video-index-table">
                                        <div class="progression-video-index-vertical-align">
                                        
                                            <h2 class="progression-video-title"><?php echo $data["name2"]; ?> </h2>
                                            ...
                                            <ul class="video-index-meta-taxonomy"><li><?php  echo $data["cast2"]; ?></li></ul>												
                                            <div class="clearfix"></div>
	...
	//echo $r;
					...
					while($data=mysqli_fetch_array($result))
                        ...
                        <div class="progression-studios-video-index-container">
                            <a href="video-seasons-post.html">
                                <div class="progression-studios-video-feaured-image"><img src="./admin_moviebazaar/assets/uploads/<?php echo $data["image3"]; ?>" style="height: 190px; alt="Featured Image"></div>
                            
                                <div class="progression-video-index-content">
                                    <div class="progression-video-index-table">
                                        <div class="progression-video-index-vertical-align">
                                        
                                            <h2 class="progression-video-title"><?php echo $data["name3"]; ?> </h2>
                                            ...
                                            <ul class="video-index-meta-taxonomy"><li><?php  echo $data["cast3"]; ?></li></ul>												
                                            <div class="clearfix"></div>
				...
				//echo $d;
					...
					while($data=mysqli_fetch_array($result))
                        ...
                        <div class="progression-studios-video-index-container">
                            <a href="video-seasons-post.html">
                                <div class="progression-studios-video-feaured-image"><img src="./admin_moviebazaar/assets/uploads/<?php echo $data["image4"]; ?>" style="height: 190px; alt="Featured Image"></div>
                            
                                <div class="progression-video-index-content">
                                    <div class="progression-video-index-table">
                                        <div class="progression-video-index-vertical-align">
                                        
                                            <h2 class="progression-video-title"><?php echo $data["name4"]; ?> </h2>
                                            ...
                                            <ul class="video-index-meta-taxonomy"><li><?php  echo $data["cast4"]; ?></li></ul>												
                                            <div class="clearfix"></div>
             ...
             <?php
				...
				//echo $d;
					$cn=mysqli_connect("localhost","root","","data");
					$s="select budget from more where mid=$id";
					$result=mysqli_query($cn,$s);
					$r=mysqli_num_rows($result);
	//echo $r;
					$n=0;
					while($data=mysqli_fetch_array($result))
						{ ?>
						<div class="content-sidebar-short-description"><?php echo $data["budget"]; ?></div>
                        <?php } ?>
            </div>
            <br>
            <h1>Production</h1>
            ...
            //echo $d;
                $cn=mysqli_connect("localhost","root","","data");
                $s="select production from more where mid=$id";
                $result=mysqli_query($cn,$s);
                $r=mysqli_num_rows($result);
//echo $r;
                $n=0;
                while($data=mysqli_fetch_array($result))
                    { ?>
                <div class="progress-bar progress-bar-striped bg-primary progress-bar-animated" role="progressbar" aria-valuenow="<?php echo $data["production"]; ?>" style="width: <?php echo $data["production"]; ?>%" aria-valuemin="0" ariavaluemax="100">
                
               
                </div>
              </div><h1>&nbsp;&nbsp;&nbsp;<?php echo $data["production"]; ?>%</h1> <?php } ?>
           </div>
