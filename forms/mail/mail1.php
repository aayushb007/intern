...
$mail = new PHPMailer();
  ...
  $q="SELECT * FROM writer where wemail='".$_REQUEST["email"]."'";
  ...
  $mail->Body = "<i>Your Password is</i>".$data[3];
  ...
  else
  {
   ...
   echo "<script>alert('Your password Sended successfully !check your mail');window.location.replace('../reg-writer.php');</script>";
  }
 ?>
